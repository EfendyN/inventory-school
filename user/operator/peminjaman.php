...
<div class="content">
        ...
        <div class="content-kanan">
            <h1>List Peminjaman | <button class="a-tambah"><a href="tambah_peminjaman.php">Tambah</a></button></h1>
            <table class="datat">
                    <thead>		
                        <tr>
                            <th>no</th>
					...
					<tr>
						...
						<td class="td-list"><button class="button-table"><a href="editPeminjaman.php?id=<?php echo $peminjaman['id_peminjaman'] ?>" id="a-table"><?php echo $peminjaman['status_peminjaman'] ?></a></button></td>
