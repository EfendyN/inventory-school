...
<div class="content">
        ...
        <div class="content-kanan">
            ...
            <table class="datat">
				<thead>		
					...
					<tr>
                        ...
                        <td class="td-list"><button class="button-table"><a href="proses/add_to_cart.php?id=<?php echo $inventaris['id_inventaris']; ?>" id="a-table">Pinjam</a></button></td>
						<!-- <td class="td-list">
			...
			<?php include 'modal-tambah-inventaris.php'; ?>
