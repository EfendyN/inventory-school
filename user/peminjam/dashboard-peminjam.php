...
<link rel="stylesheet" href="../../assets/css/dashboard-peminjam.css">
<body>
    <div class="content">
        <div class="">
            ...
            <div class="tempat-nav-sidebar">
                <nav class="nav-sidebar">
                    <ul class="ul-sidebar">
                        ...
                        <li class="li-sidebar"><button><a href="riwayat.php">Riwayat</a></button></li>
        ...
        <div class="tempat-card">
            ...
            <div class="card">
                <div class="tempat-text-card">
                    <h1 class="h1-card">Inventaris</h1>
                    <p class="p-card">2</p>
                </div>
            </div>
            <div class="card">
